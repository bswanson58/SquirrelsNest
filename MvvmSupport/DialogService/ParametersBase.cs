...
namespace MvvmSupport.DialogService {
    ...
    public abstract class ParametersBase : IParameters {  // }, IEnumerable<KeyValuePair<string, object>> {
        private readonly List<KeyValuePair<string, object ?>> mEntries = new List<KeyValuePair<string, object ?>>();
        ...
        public void Add( string key, object value ) =>
            mEntries.Add( new KeyValuePair<string, object?>( key, value ) );
        ...
        public bool TryGetValue<T>( string key, out T ? value ) =>
            mEntries.TryGetValue( key, out value );
